    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        <div class="flex justify-between border-b pb-8">
          <h1 class="font-semibold text-2xl">Cesta de la compra</h1>
          <h2 class="font-semibold text-2xl">3 Articulos</h2>
        </div>
        <div class="flex mt-10 mb-5">
          <h3 class="font-semibold text-gray-600 text-xs uppercase w-2/5">Detalle Producto</h3>
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> 
            ...
            <div class="flex flex-col justify-between ml-4 flex-grow">
              ...
              <span class="text-red-500 text-xs">Portatil</span>
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> 
            ...
            <div class="flex flex-col justify-between ml-4 flex-grow">
              ...
              <span class="text-red-500 text-xs">PC</span>
              <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-xs">Eliminar</a>
            </div>
          </div>
          <div class="flex justify-center w-1/5">
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> 
            ...
            <div class="flex flex-col justify-between ml-4 flex-grow">
              ...
              <span class="text-red-500 text-xs">Placa Base</span>
              <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-xs">Eliminar</a>
            </div>
          </div>
          <div class="flex justify-center w-1/5">
      ...
      <div id="summary" class="w-1/4 px-8 py-10">
        <h1 class="font-semibold text-2xl border-b pb-8">Resumen del pedido
      </h1>
        <div class="flex justify-between mt-10 mb-5">
          <span class="font-semibold text-sm uppercase">3 Articulos</span>
          <span class="font-semibold text-sm">590$</span>
        </div>
        <div>
          <label class="font-medium inline-block mb-3 text-sm uppercase">Metodo de envio</label>
          <select class="block p-2 text-gray-600 w-full text-sm">
            <option>Envio Standard  - $10.00</option>
          </select>
          <p>Entrega Martes, 14 de Octubre</p>
        </div>
        <div class="py-10">
          <label for="promo" class="font-semibold inline-block mb-3 text-sm uppercase">Codigo Promocion</label>
          <input type="text" id="promo" placeholder="Introduce tu Codigo" class="p-2 text-sm w-full">
        </div>
        <button class="bg-red-500 hover:bg-red-600 px-5 py-2 text-sm text-white uppercase">Probar Codigo</button>
